...
- (instancetype)initWithDevice:(IQDevice *)device {
    if ((self = [super initWithNibName:nil bundle:nil])) {
        ...
        IQApp *golfApp = [IQApp appWithUUID:[[NSUUID alloc] initWithUUIDString:@"C96BC210-7666-4195-BB5D-74AB897CFEC1"]
                                      storeUuid:[NSUUID UUID]
                                         device:device];
        IQApp *demoApp = [IQApp appWithUUID:[[NSUUID alloc] initWithUUIDString:@"64a82aff-3f75-47e6-9930-732c243794b1"]
                                      storeUuid:[NSUUID UUID]
                                         device:device];
        ...
        _appInfos[golfApp.uuid]     = [[AppInfo alloc] initWithName:@"Sample App"          IQApp:golfApp];
        _appInfos[demoApp.uuid]     = [[AppInfo alloc] initWithName:@"Demo App"          IQApp:demoApp];
    }
    return self;
}
